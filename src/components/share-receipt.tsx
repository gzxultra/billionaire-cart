  ...
  return (
    <>
      <button
        ...
        className="text-[10px] uppercase tracking-[0.2em] text-copper/40 hover:text-copper/70 transition-colors"
      >
        Share Receipt
      </button>
            ...
            >
              ...
              <div
                ...
                className="
                  ...
                  bg-vanta text-white
                  rounded-2xl border border-copper/20
                  overflow-hidden
                  scale-[0.6] origin-top sm:scale-75
                "
              >
                {/* Header */}
                <div className="border-b border-copper/20 pb-4 mb-6">
                  <div className="text-copper text-lg font-serif tracking-wider">
                    BILLIONAIRE CART
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <div className="text-copper font-serif text-sm">
                ...
                {/* Top purchases */}
                <div className="border-t border-charcoal-600/30 pt-4 mb-6">
                  ...
                  {[...purchases]
                    ...
                    .map((p, i) => (
                      <div
                        key={p.id}
                        className="flex justify-between items-center py-1.5 border-b border-charcoal-600/10"
                      >
                        <span className="text-xs text-white/50 truncate max-w-[300px]">
                          {i + 1}. {p.product.title}
                        </span>
                        <span className="text-xs font-serif text-copper/70 shrink-0 ml-2">
              ...
              <div className="flex gap-2 justify-center">
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-copper/20 text-copper text-xs hover:bg-copper/30 transition-colors"
                >
                  📥 Download PNG
                </button>
                <button
                  onClick={copyText}
                  className="px-4 py-2 rounded-lg bg-charcoal-700 text-white/50 text-xs hover:text-white/70 transition-colors"
                >
                  {copying ? "✓ Copied!" : "📋 Copy Text"}
                </button>
                <button
                  onClick={() => setIsOpen(false)}
                  className="px-4 py-2 rounded-lg bg-charcoal-700 text-white/30 text-xs hover:text-white/50 transition-colors"
                >
                  Close
                </button>
              </div>
